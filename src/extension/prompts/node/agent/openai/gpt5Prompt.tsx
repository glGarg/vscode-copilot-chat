	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			...
			<Tag name='tools_disabled_until_debug'>
				...
				<br />
				You can still use `create_file` to write reproduction scripts, and read tools (`read_file`, `grep_search`, `file_search`, `list_dir`, `run_in_terminal`) to explore the codebase.<br />
				<br />
				...
				3. **FINALLY: Verify** your changes<br />
			</Tag>
			</>}
